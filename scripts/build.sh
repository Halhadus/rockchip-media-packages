...
build_ffmpeg() {
    ...
    cd "$FFMPEG_DIR"
    run_silent "Downloading v4l2request.diff" wget -nv "https://code.ffmpeg.org/FFmpeg/FFmpeg/compare/9047fa1b084f76b1b4d065af2d743df1b40dfb56...Kwiboo:v4l2-request-n8.1.diff" -O v4l2request.diff
...
EOF
    ...
    LORE_MSGIDS=(
        ...
        "20260726-b4-add-rkvdec2-vp9-vdpu381-v1-0-180fb2d1f10c@gmail.com"
    )
