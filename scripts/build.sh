...
build_ffmpeg() {
    ...
    #run_silent "Applying v4l2request.diff" git apply --exclude='.forgejo/CODEOWNERS' --exclude='Changelog' --ignore-whitespace --ignore-space-change v4l2request.diff
    git apply --exclude='.forgejo/CODEOWNERS' --exclude='Changelog' --ignore-whitespace --ignore-space-change v4l2request.diff
